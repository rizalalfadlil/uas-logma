...
const hukum_logika = [
  {
    ...
    deskripsi:
      "Digunakan untuk menentukan syarat wajib zakat yang bersifat akumulatif. Seseorang wajib zakat JIKA (Harta ≥ Nisab) DAN (Kepemilikan ≥ 1 Tahun).",
    rumus: "p ∧ q",
  },
  {
    id: 2,
    ...
    deskripsi:
      "Digunakan untuk pengambilan keputusan. JIKA total harta mencapai Rp 197.285.000 (Premis), MAKA tampilkan status 'Wajib Zakat' (Konklusi).",
    rumus: "p ⇒ q",
  },
  {
    id: 3,
    ...
    deskripsi:
      "Digunakan untuk validasi input. Jika checkbox 'Jenis Harta' TIDAK dicentang, maka input dihilangkan.",
    rumus: "~p",
  },
  {
    id: 4,
    ...
    deskripsi:
      "Digunakan pada pemilihan jenis irigasi pertanian. Irigasi Alami (10%) ATAU Irigasi Berbayar (5%).",
    rumus: "p ∨ q",
  },
  {
    id: 5,
    nama: "Modus Ponens",
    deskripsi:
      "Premis 1: Jika mencapai nisab, maka wajib bayar. Premis 2: User mencapai nisab. Kesimpulan: User wajib bayar.",
    rumus: "((p ⇒ q) ∧ p) ⇒ q",
  },
];

  
export { dalil_zakat, hukum_logika };